...
import { setListScreenModal } from "../../redux/Marketplace";

// Get the full width of the device's screen
const { width: SCREEN_WIDTH, height: SCREEN_HEIGHT } = Dimensions.get("window");

export const ListScreenModal = ({ screen, navigation }) => {
  // dispatch
            ...
            {loading ? (
              ...
              <Animated.View style={[containerStyle, styles.modal]}>
                {screen === "Marketplace Search" && (
                  <Search hideModal={hideModal} navigation={navigation} />
                )}
                {screen === "Marketplace List" && (
                  <List hideModal={hideModal} navigation={navigation} />
                )}
              </Animated.View>
            )}
          </Animated.View>
